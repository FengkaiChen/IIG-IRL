...
class HybridDilated(nn.Module):
    ...
    def __init__(self, feat_in_size=3, feat_out_size=60, regression_hidden_size=32, viz=False):
        ...
        self.regression_block = nn.Sequential(
            nn.Conv2d(feat_out_size + 3, regression_hidden_size, 1),
            nn.ReLU(inplace=True),
    ...
    def forward(self, x):
        ...
        kinematic_in = torch.cat((feat_out, x[:, :3, :, :]), dim=1)
